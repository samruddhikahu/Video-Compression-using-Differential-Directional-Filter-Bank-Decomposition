function x = wfb2rec1(DWT, lvl, h, g)
...
[m, n] = size(DWT);
x_LL = DWT(1:(m/(2^lvl)),1:(n/(2^lvl)));

for i = lvl:-1:1
    clear x_LH x_HL x_HH x_B x_L x_H;
    a = 2^i; b = 2^(i-1);
    
    x_HL = DWT(((m/a)+1):(m/b),1:(n/a));
    x_LH = DWT(1:(m/a),((n/a)+1):(n/b));
    x_HH = DWT(((m/a)+1):(m/b),((n/a)+1):(n/b));
