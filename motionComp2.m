...
function imgComp = motionComp2(imgI, MVD, mbSize)
...
for i = 1:mbSize:row-mbSize+1
    for j = 1:mbSize:col-mbSize+1
        ...
        motionVect(:,mbCount) = MVD(:,mbCount) + MVp(:,mbCount);
        ...
        mbCount = mbCount + 1;
        MVp(:,mbCount) = motion_vector_pred(motionVect, [row, col], mbSize, mbCount);
    end
end
